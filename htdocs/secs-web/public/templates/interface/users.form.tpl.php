...
{/foreach}
{if $smarty.session.logged eq $1[0] or $smarty.session.role eq "Administrator"}
...
<div id="formRow14" class="formRow" {if $smarty.session.role neq "Administrator"}style="display: none;"{/if}>
        <label for="role">{$BVS_LANG.lblRole}</label>
            ...
            {section name=iten loop=$4}
            <div class="frDataFields">
                <div class="frDFRow">
                    <div id="roleLib">
                        <div id="frDataFieldsRole{$smarty.section.iten.index}" class="frDFColumn">
                            <input type="text" name="field[role][]" id="role" value="{$4[iten]}" readonly="readonly" title="{$BVS_LANG.lblRole}" class="textEntry">
                        </div>
                        <div id="frDataFieldsLibrary{$smarty.section.iten.index}" class="frDFColumn">
                            <input type="text" name="field[library][]" id="library" value="{$5[iten]}" readonly="readonly" title="{$BVS_LANG.lblLibrary}" class="textEntry" >
                            <input type="hidden" name="field[libraryDir][]" id="libraryDir" value="{$6[iten]}" readonly="readonly">
                        ...
                        <div id="roleLib">
                            <div id="frDataFieldsrolep" class="frDFColumn">
                                <select name="field[role][]" id="role" readonly="readonly" title="{$BVS_LANG.lblRole}" class="textEntry">
                                    {html_options options=$BVS_LANG.optRole selected=$4[iten]}
                                </select>
                            </div>
                            <div id="frDataFieldslibraryp" class="frDFColumn">
                                <select name="field[library][]" id="library" readonly="readonly" title="{$BVS_LANG.lblLibrary}" class="textEntry">
                                    {html_options options=$BVS_LANG.optRole selected=$5[iten]}
                                </select>
...
<div class="formContent">
	...
	<div id="formRow04" class="formRow" >
		...
		<div class="frDataFields">
			<input name="field[email]" id="email" value="{$11[0]}" class="textEntry superTextEntry" onfocus="this.className = 'textEntry superTextEntry textEntryFocus';document.getElementById('formRow04').className = 'formRow formRowFocus';" onblur="this.className = 'textEntry superTextEntry';document.getElementById('formRow04').className = 'formRow';" />
	...
	<div id="formRow10" class="formRow" {if $smarty.session.role neq "Administrator"}style="display: none;"{/if}>
		...
		<div class="frDataFields">
			<textarea name="field[notes]" id="notes" class="textEntry singleTextEntry" rows="4" cols="50" onfocus="this.className = 'textEntry singleTextEntry textEntryFocus';document.getElementById('formRow10').className = 'formRow formRowFocus';" onblur="this.className = 'textEntry singleTextEntry';document.getElementById('formRow10').className = 'formRow';" >{$10[0]}</textarea>
