...
<form action="{$smarty.server.PHP_SELF}?m={$smarty.get.m}&amp;title={$titleCode}&amp;edit=save" enctype="multipart/form-data" name="formData" id="formData" class="form"  method="post" >	
    ...
    <input type="hidden" name="field[titleCode]" value="{if $30[0]}{$30[0]}{else}{$titleCode}{/if}"/>
    ...
    <div class="formHead">
        ...
        {/if}
        {if $30 or $titleCode}
        <div>ID={if $titleCode}{$titleCode}{else}{$30}{/if}</div>
        {/if}
    ...
    <div class="formContent">
        <div id="formRow08" class="formRow">
            ...
            <div class="frDataFields">
                <!--input type="text" name="field[acquisitionMethod]" id="acquisitionMethod" value="{$901}" title="{$BVS_LANG.lblAcquisitionMethod}" class="textEntry superTextEntry" onfocus="this.className = 'textEntry superTextEntry textEntryFocus';document.getElementById('formRow8').className = 'formRow formRowFocus';" onblur="this.className = 'textEntry superTextEntry';document.getElementById('formRow8').className = 'formRow';" /-->
                <select name="field[acquisitionMethod]" id="acquisitionMethod" class="textEntry superTextEntry" title="* {$BVS_LANG.lblAcquisitionMethod}">
                    {html_options options=$BVS_LANG.optAcquisitionMethod selected=$901[0]}
                </select>
        ...
        <div id="formRow01" class="formRow">
            ...
            <div class="frDataFields">
                <select name="field[acquisitionControl]" id="acquisitionControl" class="textEntry superTextEntry" title="* {$BVS_LANG.lblAcquisitionControl}">
                    {html_options options=$BVS_LANG.optAcquisitionControl selected=$902[0]}
                </select>
        ...
        <div id="formRow16" class="formRow">
            ...
            <div class="frDataFields">
                <!--input type="text" name="field[acquisitionPriority]" id="acquisitionPriority" value="{$946}" title="{$BVS_LANG.lblAcquisitionPriority}" class="textEntry superTextEntry" onfocus="this.className = 'textEntry superTextEntry textEntryFocus';document.getElementById('formRow16').className = 'formRow formRowFocus';" onblur="this.className = 'textEntry superTextEntry';document.getElementById('formRow16').className = 'formRow';" /-->
                <select name="field[acquisitionPriority]" id="acquisitionPriority" class="textEntry superTextEntry" title="* {$BVS_LANG.lblAcquisitionPriority}">
                    {html_options options=$BVS_LANG.optAcquisitionPriority selected=$946[0]}
                </select>
    ...
    <div class="formHead">
        <div id="formRow913" class="formRow">
            ...
            <div class="frDataFields">
                ...
                {section name=iten loop=$450}
                <div id="frDataFieldsacquisitionHistory{$smarty.section.iten.index}" class="frDataFields">
                    <input type="text" name="field[acquisitionHistory][]" id="acquisitionHistory{$smarty.section.iten.index}" value="{$913[iten]}" class="textEntry singleTextEntry" onfocus="this.className = 'textEntry singleTextEntry textEntryFocus';document.getElementById('formRow54').className = 'formRow formRowFocus';" onblur="this.className = 'textEntry singleTextEntry';document.getElementById('formRow54').className = 'formRow';" />
                ...
                <div id="frDataFieldsacquisitionHistory" class="frDataFields">
                    <input type="text" name="field[acquisitionHistory][]" id="acquisitionHistory" value="{$913[0]}" class="textEntry singleTextEntry" onfocus="this.className = 'textEntry singleTextEntry textEntryFocus';document.getElementById('formRow54').className = 'formRow formRowFocus';" onblur="this.className = 'textEntry singleTextEntry';document.getElementById('formRow59').className = 'formRow';" />
    ...
    <div class="formContent">
        ...
        <div id="formRow11" class="formRow">
            ...
            {section name=iten loop=$907}
            <div id="frDataFieldslocationRoom{$smarty.section.iten.index}" class="frDataFields">
                <input type="text" name="field[locationRoom][]" id="locationRoom" value="{$907[iten]}" title="{$BVS_LANG.lblLocationRoom}" class="textEntry superTextEntry2" onfocus="this.className = 'textEntry superTextEntry2 textEntryFocus';document.getElementById('formRow11').className = 'formRow formRowFocus';" onblur="this.className = 'textEntry superTextEntry2';document.getElementById('formRow11').className = 'formRow';" />
            ...
            <div id="frDataFieldslocationRoomp" class="frDataFields">
                <input type="text" name="field[locationRoom][]" id="locationRoom" value="{$907}" title="{$BVS_LANG.lblLocationRoom}" class="textEntry superTextEntry2" onfocus="this.className = 'textEntry superTextEntry2 textEntryFocus';document.getElementById('formRow12').className = 'formRow formRowFocus';" onblur="this.className = 'textEntry superTextEntry2';document.getElementById('formRow11').className = 'formRow';" />
        ...
        <div id="formRow12" class="formRow">
            ...
            {section name=iten loop=$908}
            <div id="frDataFieldsEstMap{$smarty.section.iten.index}" class="frDataFields">
                <input type="text" name="field[estMap][]" id="estMap" value="{$908[iten]}" title="{$BVS_LANG.lblEstMap}" class="textEntry superTextEntry2" onfocus="this.className = 'textEntry superTextEntry2 textEntryFocus';document.getElementById('formRow12').className = 'formRow formRowFocus';" onblur="this.className = 'textEntry superTextEntry2';document.getElementById('formRow12').className = 'formRow';" />
            ...
            <div id="frDataFieldsestMapp" class="frDataFields">
                <input type="text" name="field[estMap][]" id="estMap" value="{$908}" title="{$BVS_LANG.lblEstMap}" class="textEntry superTextEntry2" onfocus="this.className = 'textEntry superTextEntry2 textEntryFocus';document.getElementById('formRow12').className = 'formRow formRowFocus';" onblur="this.className = 'textEntry superTextEntry2';document.getElementById('formRow12').className = 'formRow';" />
        ...
        <div id="formRow13" class="formRow">
            ...
            {section name=iten loop=$909}
            <div id="frDataFieldsOwnClassif{$smarty.section.iten.index}" class="frDataFields">
                <input type="text" name="field[ownClassif][]" id="ownClassif" value="{$909[iten]}" title="{$BVS_LANG.lblOwnClassif}" class="textEntry superTextEntry2" onfocus="this.className = 'textEntry superTextEntry2 textEntryFocus';document.getElementById('formRow13').className = 'formRow formRowFocus';" onblur="this.className = 'textEntry superTextEntry2';document.getElementById('formRow13').className = 'formRow';" />
            ...
            <div id="frDataFieldsownClassifp" class="frDataFields">
                <input type="text" name="field[ownClassif][]" id="ownClassif" value="{$909}" title="{$BVS_LANG.lblOwnClassif}" class="textEntry superTextEntry2" onfocus="this.className = 'textEntry superTextEntry2 textEntryFocus';document.getElementById('formRow13').className = 'formRow formRowFocus';" onblur="this.className = 'textEntry superTextEntry2';document.getElementById('formRow13').className = 'formRow';" />
        ...
        <div id="formRow14" class="formRow">
            ...
            {section name=iten loop=$910}
            <div id="frDataFieldsOwnDesc{$smarty.section.iten.index}" class="frDataFields">
                <input type="text" name="field[ownDesc][]" id="ownDesc" value="{$910[iten]}" title="{$BVS_LANG.lblOwnDesc}" class="textEntry superTextEntry2" onfocus="this.className = 'textEntry superTextEntry2 textEntryFocus';document.getElementById('formRow14').className = 'formRow formRowFocus';" onblur="this.className = 'textEntry superTextEntry2';document.getElementById('formRow14').className = 'formRow';" />
            ...
            <div id="frDataFieldsownDescp" class="frDataFields">
                <input type="text" name="field[ownDesc][]" id="ownDesc" value="{$910}" title="{$BVS_LANG.lblOwnDesc}" class="textEntry superTextEntry2" onfocus="this.className = 'textEntry superTextEntry2 textEntryFocus';document.getElementById('formRow14').className = 'formRow formRowFocus';" onblur="this.className = 'textEntry superTextEntry2';document.getElementById('formRow14').className = 'formRow';" />
    ...
    <div class="formHead">
        <div id="formRow03" class="formRow">
            ...
            <div class="frDataFields">
                {if $940[0]}{$940[0]}{else}{$smarty.now|date_format:"%Y%m%d"}{/if}
                <input type="hidden" name="field[creatDate]" value='{if $940[0]}{$940[0]}{else}{$smarty.now|date_format:"%Y%m%d"}{/if}' class="textEntry superTextEntry"/>
            </div>
            <div class="spacer">&#160;</div>
        </div>
        ...
        <div id="formRow03" class="formRow">
            ...
            <div class="frDataFields">
                {if $950[0]}{$950[0]}{else}{$smarty.session.logged}{/if}
                <input type="hidden" name="field[dataEntryCreat]" value='{if $950[0]}{$950[0]}{else}{$smarty.session.logged}{/if}' class="textEntry superTextEntry" />
            </div>
            <div class="spacer">&#160;</div>
        </div>
