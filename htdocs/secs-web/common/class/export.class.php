...
function exportTitle($exportType, $ibictID, $numberRegisters ,$formatType, $registerID, $searchExpr, $indexes){
        ...
        if($serverOS == "Win32"){
            ...
            $pathMX = BVS_DIR."\\cgi-bin\\mx.exe";
            $pathMXCP = BVS_DIR."\\cgi-bin\\mxcp.exe";
            $pathTitleDB = BVS_DIR."\\bases\\secs-web\\title";
            $pathTitleISO = BVS_DIR."\\temp\\secs-web\\title-".$_SESSION["centerCode"].date("Ymd-Gi");
            $pathHldgDB = BVS_DIR."\\bases\\secs-web\\".$_SESSION["libraryDir"]."\\holdings";
            $pathTempTitle = BVS_DIR."\\temp\\secs-web\\temptitle-".$_SESSION["centerCode"].date("Ymd-Gi");
            $pathTempHldg = BVS_DIR."\\temp\\secs-web\\tempholdings-".$_SESSION["centerCode"].date("Ymd-Gi");
            $titleFST = BVS_DIR."\\bases\\secs-web\\title.fst";
            $tempTitleFST = BVS_DIR."\\temp\\secs-web\\temptitle-".$_SESSION["centerCode"].date("Ymd-Gi").".fst";
            $hldgFST = BVS_DIR."\\bases\\secs-web\\main\\holdings.fst";
            $tempHldgFST = BVS_DIR."\\temp\\secs-web\\tempholdings-".$_SESSION["centerCode"].date("Ymd-Gi").".fst";
            $goTempDirectory = BVS_DIR."\\temp\\secs-web\\";
            $pathISOTitle = BVS_DIR."\\temp\\secs-web\\exported-".$_SESSION["centerCode"].date("Ymd-Gi");
            $newFile = BVS_DIR."\\temp\\".$_SESSION["centerCode"].date("Ymd-Gi");

        }else{
            //Variaveis para Linux
            $pathMX = BVS_DIR."/cgi-bin/mx";
            $pathMXCP = BVS_DIR."/cgi-bin/mxcp";
            $pathTitleDB = BVS_DIR."/bases/secs-web/title";
            $pathTitleISO = BVS_DIR."/temp/secs-web/title-".$_SESSION["centerCode"].date("Ymd-Gi");
            $pathHldgDB = BVS_DIR."/bases/secs-web/".$_SESSION["libraryDir"]."/holdings";
            $pathTempTitle = BVS_DIR."/temp/secs-web/temptitle-".$_SESSION["centerCode"].date("Ymd-Gi");
            $pathTempHldg = BVS_DIR."/temp/secs-web/tempholdings-".$_SESSION["centerCode"].date("Ymd-Gi");
            $titleFST = BVS_DIR."/bases/secs-web/title.fst";
            $tempTitleFST = BVS_DIR."/temp/secs-web/temptitle.fst";
            $hldgFST = BVS_DIR."/bases/secs-web/main/holdings.fst";
            $tempHldgFST = BVS_DIR."/temp/secs-web/tempholdings-".$_SESSION["centerCode"].date("Ymd-Gi").".fst";
            $goTempDirectory = BVS_DIR."/temp/secs-web/";
            $pathISOTitle = BVS_DIR."/temp/secs-web/exported-".$_SESSION["centerCode"].date("Ymd-Gi");
            $newFile = BVS_DIR."/temp/".$_SESSION["centerCode"].date("Ymd-Gi");
        }
