...
define("NAME_SYSTEM","[SeCS-Web] -  Administra&#231;&#227;o");
...
$BVS_CONF["temp_dir"] = BVS_ROOT_DIR."/../../temp";
...
if($serverOS == "Win32"){
    //Windows variables
    $BVS_CONF['PATHMX'] = BVS_DIR."\\cgi-bin\\mx.exe";
    $BVS_CONF['PATHMXTB'] = BVS_DIR."\\cgi-bin\\mxtb.exe";
}else{
    //Linux variables
    $BVS_CONF['PATHMX'] = BVS_DIR."/cgi-bin/mx";
    $BVS_CONF['PATHMXTB'] = BVS_DIR."/cgi-bin/mxtb";
}
