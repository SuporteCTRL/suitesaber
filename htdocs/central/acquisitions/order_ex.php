...
foreach ($order as $prov=>$linea){
	...
	foreach ($linea as $l){
		...
		<input type=\"hidden\" name=\"volume_\"  ".$cell[1]." value=\"  \">
		<input type=\"hidden\" name=\"tome_\" ".$cell[1]."    value=\"  \">
		<input type=\"hidden\" name=\"acqtype_\" ".$cell[1]." value=\"  \">
    ...
    <input class=\"btn btn-primary\" type=\"submit\" value=\" ".$msgstr["submit"]."\" onclick=\"EnviarForma('form_$form','".$cell[1]."')\">
