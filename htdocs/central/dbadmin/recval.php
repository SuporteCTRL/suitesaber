...
//		if ($tag!=""){
			...
			echo $y[0];
			echo "</textarea></td><td bgcolor=white>
			<a class=\"btn btn-default\" href=\"javascript:EditarFormato($ix)\"><i class=\"fa fa-pencil-square-o\" aria-hidden=\"true\"></i></a>&nbsp; &nbsp;

			<a class=\"btn btn-default\" href=javascript:DeleteElement(".$ix.")><i class=\"fa fa-times\" aria-hidden=\"true\">
 </a></i>";
