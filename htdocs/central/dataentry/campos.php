...
function RefrescarPicklist(tabla,Ctrl,valor){
	...
	msgwin=window.open("","Picklist","width=30,height=10,scrollbars, resizable")
...
function AgregarPicklist(tabla,Ctrl,valor){
	...
	msgwin=window.open("","Picklist","width=700,height=500,scrollbars, resizable")
...
function EnviarArchivo(Tag,subc){
		...
		msgwin=window.open("","Upload","status=yes,resizable=yes,toolbar=no,menu=no,scrollbars=yes,width=880,height=180,top=100,left=5");
...
<script language=javascript>
	...
	function AbrirIndiceAlfabetico(xI,Prefijo,SubC,Separa,db,cipar,tag,Formato){
		...
		url_indice="capturaclaves.php?opcion=autoridades&base="+db+"&cipar="+cipar+"&Tag="+xI+Prefijo+"&indice="+xI+"&repetible=0"+"&Formato="+Formato+"&postings=10&sfe=s"
  		msgwin=window.open(url_indice,"indice","width=650, height=520,resizable, scrollbar")
  		msgwin.focus()
    	return
	...
	function AbrirIndice(ira){
		...
		msgwin=window.open(url_indice,"Indice","status=yes,resizable=yes,toolbar=no,menu=yes,scrollbars=yes,width=650,height=520,top=20,left="+ancho)
		msgwin.focus()
	}
	...
	function Ayuda(tag,help){
		...
		msgwin=window.open(url,"Ayuda","status=yes,resizable=yes,toolbar=no,menu=yes,scrollbars=yes,width=700,height=400,top=100,left=100")
		msgwin.focus()
	}
...
<br><center>
<table width=250 bgcolor=#FFFFFF border=0 cellspacing=5>
	<td align=center>
