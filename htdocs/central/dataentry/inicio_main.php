...
function BarcodeThis(){
	if (browseby=="search")
  		...
  		mfn_edit=mfn
  	msgwin=window.open("../barcode/barcode_1reg_ex.php?base="+base+"&print=Y&desde="+mfn+"&hasta="+mfn,"barcode","width=400,height=400,menubar=yes, scrollbars=yes, resizable=yes")
...
<frameset rows=<?php if (isset($FRAME_1H) and trim($FRAME_1H)!="") echo $FRAME_1H; else echo '50';?>,<?php if (isset($FRAME_2H) and trim($FRAME_2H)!="") echo $FRAME_2H; else echo $Menu_H; ?>,* cols=*6 border=0>
<?php
if (isset($arrHttp["base"])){
