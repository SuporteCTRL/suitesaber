<?php /* Smarty version 2.6.18, created on 2012-06-14 09:50:06
         compiled from facic.list.tpl.php */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'facic.list.tpl.php', 29, false),)), $this); ?>
...
$this->_smarty_include(array('smarty_include_tpl_file' => "facic.list.form.tpl.php", 'smarty_include_vars' => array()));
...
unset($_smarty_tpl_vars);
 ?>
    ...
    <div id="SavingMessageDialog">
        ...
        <div class="bd">
            <div><?php echo $this->_tpl_vars['BVS_LANG']['msgSaving']; ?>
</div>
        </div>
    </div>
    ...
    <div id="dialog1">
        <div class="hd"><?php echo $this->_tpl_vars['BVS_LANG']['lblSelectMask']; ?>
</div>
        <div class="bd">
            <form id="maskForm" method="POST" action="?m=facic&title=<?php echo $_GET['title']; ?>
&initialDate=<?php echo $_GET['initialDate']; ?>
&initialVolume=<?php echo $_GET['initialVolume']; ?>
&initialNumber=<?php echo $_GET['initialNumber']; ?>
">
                <label for="selectMask"><strong><?php echo $this->_tpl_vars['BVS_LANG']['mask']; ?>
</strong></label>
 ...
 - <?php echo $this->_tpl_vars['BVS_LANG']['lblSelectMask']; ?>
</h2>
    ...
    <div id="addRowsDialog">
        <div class="hd"><?php echo $this->_tpl_vars['BVS_LANG']['lblYear']; ?>
</div>
        <div class="bd">
            <form method="POST" action="#">
                <select id="untilYear" name="untilYear" class="smallTextEntry">
                   <?php echo smarty_function_html_options(array('values' => $this->_tpl_vars['yearList'],'output' => $this->_tpl_vars['yearList']), $this);?>
    ...
    <div id="collectionDialog">
        <div class="hd"><?php echo $this->_tpl_vars['BVS_LANG']['lblHldg']; ?>
</div>
        <div class="bd">
...
<form name="formReload" method="POST" action="?m=facic&title=<?php echo $_GET['title']; ?>
&initialDate=<?php echo $_GET['initialDate']; ?>
&initialVolume=<?php echo $_GET['initialVolume']; ?>
&initialNumber=<?php echo $_GET['initialNumber']; ?>
">
...
var msgInvalidMaskForThisFacic = '<?php echo $this->_tpl_vars['BVS_LANG']['msgInvalidMaskForThisFacic']; ?>
';
var i_new = 0;
var facicCount = <?php echo $this->_tpl_vars['totalRecords']; ?>
;
<?php echo $this->_tpl_vars['x']; ?>

var today = "<?php echo $this->_tpl_vars['today']; ?>
";
var username = "<?php echo $_SESSION['logged']; ?>
";
var lblHldgMessage = "<?php echo $this->_tpl_vars['BVS_LANG']['lblHldgMessage']; ?>
";
var currentMask = "<?php echo $this->_tpl_vars['currentMask']; ?>
";
var initialDate = "<?php echo $_GET['initialDate']; ?>
";
var thisTable = null;
var msgWaiting = "<?php echo $this->_tpl_vars['BVS_LANG']['msgWaiting']; ?>
";
...
";
var lblIssue = "<?php echo $this->_tpl_vars['BVS_LANG']['lblFacic']; ?>
";
var lblFacic  = "<?php echo $this->_tpl_vars['BVS_LANG']['lblIssueNumber']; ?>
";
var lblMask = "<?php echo $this->_tpl_vars['BVS_LANG']['mask']; ?>
";
var lblAction = "<?php echo $this->_tpl_vars['BVS_LANG']['lblAction']; ?>
";
var lblYear = "<?php echo $this->_tpl_vars['BVS_LANG']['lblYear']; ?>
";
var lblVol = "<?php echo $this->_tpl_vars['BVS_LANG']['lblVol']; ?>
";
var lblStatus = "<?php echo $this->_tpl_vars['BVS_LANG']['lblColPA']; ?>
";
var lblType = "<?php echo $this->_tpl_vars['BVS_LANG']['lblColPubType']; ?>
";
var lblQtd = "<?php echo $this->_tpl_vars['BVS_LANG']['lblColQtd']; ?>
";
...
";
var btAddFasc = "<?php echo $this->_tpl_vars['BVS_LANG']['btAddFasc']; ?>
";
var btInsertFascBetween = "<?php echo $this->_tpl_vars['BVS_LANG']['btInsFascBetween']; ?>
";
...
var centerCode = "<?php echo $_SESSION['centerCode']; ?>
";
var btInsertRecord = "<?php echo $this->_tpl_vars['BVS_LANG']['btInsertRecord']; ?>
";
var btDeleteRecord = "<?php echo $this->_tpl_vars['BVS_LANG']['btDeleteRecord']; ?>
";
...
"></a></span>
 ...
 <?php echo $this->_tpl_vars['BVS_LANG']['lblSearchIssue']; ?>
</h2>
            <div class="help_message">
                <?php echo $this->_tpl_vars['BVS_LANG']['helpSearchIssue']; ?>
